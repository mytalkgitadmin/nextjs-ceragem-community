...
import { MessageCustomType, MessageInDataType } from "@/entities/message";
import { MessageData } from "../types";
import {
  FileInfo,
  UploadResult,
} from "@/entities/attachment/model/file-upload";
...
export default function useSendbirdMessage() {
  ...
  const sendFileMessage_ = sendbirdSelectors.getSendFileMessage(store);
  ...
  const sendFileMessage = async (
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        sendFileMessage_(currentChannel, params)
          .onSucceeded((message) => {
