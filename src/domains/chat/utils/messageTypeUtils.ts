...
import {
  ...
  FILE_TYPE_MAPPING,
  MessageType,
} from "../constants/messageTypeConst";
  ...
  if (message.messageType === "file") {
    ...
    try {
      if ((message as any).data) {
        const customData = getMessageData(message);
    ...
    return getFileMessageType(message);
  }
 ...
 */
export function getFileMessageType(message: BaseMessage): MessageType {
